...
INSERT INTO `address` (`id`, `street`, `city`, `state`, `zip_code`) VALUES (6, '321 second grooming st', 'grooming city', 'NC', '28394');
...
INSERT INTO `business` (`id`, `name`, `about`, `phone`, `image_url`, `address_id`) VALUES (2, 'beautiful pet grooming service', 'top-notch grooming service', '4325678485', NULL, 5);
INSERT INTO `business` (`id`, `name`, `about`, `phone`, `image_url`, `address_id`) VALUES (3, 'grooming groom', 'let\'s make your pet looks nice', '2323452334', NULL, 6);
...
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `email`, `phone`, `image_url`, `created_at`, `updated_at`, `business_id`, `address_id`) VALUES (2, 'vet', '$2a$10$4SMKDcs9jT18dbFxqtIqDeLEynC7MUrCEUbv1a/bhO.x9an9WGPvm', 1, 'provider', 'vet@email.com', '987643234', NULL, NULL, NULL, 1, 1);
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `email`, `phone`, `image_url`, `created_at`, `updated_at`, `business_id`, `address_id`) VALUES (3, 'owner', '$2a$10$4SMKDcs9jT18dbFxqtIqDeLEynC7MUrCEUbv1a/bhO.x9an9WGPvm', 1, 'parent', 'dogowner@email.com', '3456789876', NULL, NULL, NULL, NULL, 2);
INSERT INTO `user` (`id`, `username`, `password`, `enabled`, `role`, `email`, `phone`, `image_url`, `created_at`, `updated_at`, `business_id`, `address_id`) VALUES (4, 'test', '$2a$10$4SMKDcs9jT18dbFxqtIqDeLEynC7MUrCEUbv1a/bhO.x9an9WGPvm', 1, 'parent', 'test@test.com', '123456789', NULL, NULL, NULL, NULL, 4);
...
INSERT INTO `service_provided_by_business` (`service_type_id`, `business_id`) VALUES (2, 3);
